...
\begin{tcolorbox}[enhanced jigsaw, breakable, colframe=quarto-callout-caution-color-frame, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{AI use}, colback=white, coltitle=black, bottomtitle=1mm, rightrule=.15mm, opacityback=0, toptitle=1mm, titlerule=0mm, arc=.35mm, left=2mm, opacitybacktitle=0.6, bottomrule=.15mm, colbacktitle=quarto-callout-caution-color!10!white, toprule=.15mm, leftrule=.75mm]
