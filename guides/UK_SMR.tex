...
\begin{tcolorbox}[enhanced jigsaw, colback=white, bottomtitle=1mm, toprule=.15mm, colframe=quarto-callout-warning-color-frame, toptitle=1mm, colbacktitle=quarto-callout-warning-color!10!white, breakable, opacitybacktitle=0.6, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{WARNING - Disclaimer}, coltitle=black, leftrule=.75mm, left=2mm, titlerule=0mm, bottomrule=.15mm, arc=.35mm, opacityback=0, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, bottomtitle=1mm, toprule=.15mm, colframe=quarto-callout-caution-color-frame, toptitle=1mm, colbacktitle=quarto-callout-caution-color!10!white, breakable, opacitybacktitle=0.6, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{AI use}, coltitle=black, leftrule=.75mm, left=2mm, titlerule=0mm, bottomrule=.15mm, arc=.35mm, opacityback=0, rightrule=.15mm]
