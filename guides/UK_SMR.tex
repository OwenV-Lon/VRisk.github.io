...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, opacityback=0, rightrule=.15mm, arc=.35mm, coltitle=black, colframe=quarto-callout-warning-color-frame, colbacktitle=quarto-callout-warning-color!10!white, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{WARNING - Disclaimer}, bottomtitle=1mm, leftrule=.75mm, toprule=.15mm, toptitle=1mm, breakable, titlerule=0mm, left=2mm, colback=white, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, opacityback=0, rightrule=.15mm, arc=.35mm, coltitle=black, colframe=quarto-callout-caution-color-frame, colbacktitle=quarto-callout-caution-color!10!white, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{AI use}, bottomtitle=1mm, leftrule=.75mm, toprule=.15mm, toptitle=1mm, breakable, titlerule=0mm, left=2mm, colback=white, opacitybacktitle=0.6]
